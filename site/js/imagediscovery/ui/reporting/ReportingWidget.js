...
define([
    ...
    function (declare, locale, topic, array, lang, json, Color, template, UITemplatedWidget, MapDrawSupport, ReportingViewModel, Button, SimpleFillSymbol, SimpleLineSymbol, QueryTask, Query, ImageServiceParameters) {
        return declare(
