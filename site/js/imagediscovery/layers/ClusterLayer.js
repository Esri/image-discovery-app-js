define([
    ...
    function (declare, GraphicsLayer, SimpleMarkerSymbol, PopupTemplate, SpatialReference, Point, Graphic, TextSymbol, Color, con, array) {
        return declare(
            [GraphicsLayer],
            {
                ...
                _setMap: function (map, surface) {
                    ...
                    this._zoomEnd = con.connect(map, "onZoomEnd", this, function () {
                        // update resolution
                ...
                _updateLabel: function (c) {
                    ...
                    var label = array.filter(this.graphics, function (g) {
                        return g.symbol &&
                            g.symbol instanceof  TextSymbol &&
                            g.attributes.clusterId == c.attributes.clusterId;
                    });
                    if (label.length == 1) {
                        this.remove(label[0]);
